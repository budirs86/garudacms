          ...
          <div class="col-md-6">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Subdomain</h3>
              </div>
              <!-- /.card-header -->
              @if ($errors->any())
              ...
              @endif
              <!-- form start -->
              <form class="form-horizontal" action="{{ route('unit_kerja_store') }}" method="POST">
                {{ csrf_field() }}
                <div class="card-body">
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Link</label>
                    <div class="col-sm-10">
                      <input type="text" name="link" class="form-control" id="inputEmail3" placeholder="Link subdomain">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Unit/Subdomain</label>
                    <div class="col-sm-10">
                      <input type="text" name="unit_kerja" class="form-control" id="inputPassword3" placeholder="Unit/nama subdomain">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
