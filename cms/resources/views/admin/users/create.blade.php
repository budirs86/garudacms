              ...
              <form class="form-horizontal" action="{{ route('users_store') }}" method="POST">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <div class="col-sm-9">
                        <input type="text" name="name" class="form-control" id="inputEmail3" placeholder="Nama Penguna">
                      </div>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <div class="col-sm-9">
                        <input type="text" name="email" class="form-control" id="inputEmail3" placeholder="Alamat email">
                      </div>
                    </div>
                  </div>
                  <div class="form-group row">
