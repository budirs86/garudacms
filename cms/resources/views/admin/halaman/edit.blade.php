        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              ...
              @endif
              <!-- form start -->
              <form class="form-horizontal" action="{{ route('halaman_update') }}" method="POST">
                {{ csrf_field() }}
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="title" class="form-control" id="inputEmail3"  value="{{ $pages->title}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Deskripsi</label>
                    <div class="col-sm-10">
                      <textarea name="content" class="form-control" cols="80" rows="12" id="summernote">{{ $pages->content }}</textarea>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
