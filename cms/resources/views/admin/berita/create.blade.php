        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              ...
              @endif
              <!-- form start -->
              <form class="form-horizontal" action="{{ route('berita_store') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <textarea name="content" class="form-control" cols="80" rows="24" id="summernote"></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
