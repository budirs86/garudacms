        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-info">
              ...
              @endif
              <!-- form start -->
              <form class="form-horizontal" action="{{ route('info_update') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="title" class="form-control"  placeholder="Judul" value="{{ $info->title }}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Deskripsi</label>
                    <div class="col-sm-10">
                      <textarea name="description" class="form-control" cols="80" rows="24" id="summernote">{{ $info->description }}</textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Foto</label>
                    <div class="col-sm-10">
                      <img src="{{ asset('images/info/'.$info->pic)}}" width="400"><br>
                    </div>
                  </div>
                  <div class="form-group row">
                ...
                <div class="card-footer">
                  ...
                  <a href="{{ url('admin/info') }}" class="btn btn-default float-right">Batal</a>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
