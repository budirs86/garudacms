        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-info">
              ...
              @endif
              <!-- form start -->
              <form class="form-horizontal" action="{{ route('logo_update') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <input type="hidden" name="id" class="form-control" value="{{ $logo->id }}">
                <div class="card-body">
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Logo</label>
                    <div class="col-sm-10">
                      <img src="{{ asset('images/logo/'.$logo->pic)}}" width="400"><br>
                    </div>
                  </div>
                  <div class="form-group row">
                ...
                <div class="card-footer">
                  ...
                  <a href="{{ url('admin/logo') }}" class="btn btn-default float-right">Batal</a>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
