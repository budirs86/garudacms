        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              ...
              @endif
              <!-- form start -->
              <form class="form-horizontal" action="{{ route('pengumuman_store') }}" method="POST">
                {{ csrf_field() }}
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Pengumuman</label>
                    <div class="col-sm-10">
                ...
                <div class="card-footer">
                  ...
                  <a href="{{ url('admin/pengumuman') }}" class="btn btn-default float-right">Batal</a>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
