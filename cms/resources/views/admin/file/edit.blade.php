        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-info">
              ...
              @endif
              <!-- form start -->
              <form class="form-horizontal" action="{{ route('file_update') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <img src="{{ asset('images/file/'.$info->pic)}}" width="400"><br>
                    </div>
                  </div>
                  <div class="form-group row">
                ...
                <div class="card-footer">
                  ...
                  <a href="{{ url('admin/file') }}" class="btn btn-default float-right">Batal</a>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
